...
2. run the following command:
  ...
  Scenario Outline: Post course register
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                    | data                                                                                                                                                                              | expectval                                             |
      | http://localhost:3000/course/register | { "Title":"Android","Description":"loremipsum","Credit":"110","Fee":"25000","CourseImage":"asd.jpg","StartDate":"2020-06-06","EndDate":"2020-06-09","CourseTypeID":"1","TeacherID":"1"} | { "status": 200, "message": "New Course Date Registered"} |