...
2. run the following command:
  ...
  Scenario Outline: Post teacher register
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                    | data                                                                                                                                                                                               | expectval                                             |
      | http://localhost:3000/teacher/register | { "Email":"pasanglakpasherpa@gmail.com","Password":"asd","FirstName":"Pasanglakpa","LastName":"Sherpa","DOB":"1999-06-01","Gender":"male","Phone":"9817849333","Address":"Baneshwor","Bio":"Loremipsum", "StudentID":"1" } | { "status": 200, "message": "New Teacher Registered"} |