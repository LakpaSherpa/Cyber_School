...
2. run the following command:
  ...
  Scenario Outline: Put course update
    * Put to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                   | data                                                                                                                          | expectval                                          |
      | http://localhost:3000/course/update/1 | { "Title":"Android","Description":"loremipsum","Credit":"110","Fee":"25000","StartDate":"2020-06-06","EndDate":"2020-06-09" } | { "status": 200, "message": "course data updated"} |