...
2. run the following command:
  ...
  Scenario Outline: Put coursetype update
    * Put to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                   | data                                                                                                                          | expectval                                          |
      | http://localhost:3000/course/update/1 | { "id":"1","course_title":"Android","createdAt":"2020-06-06","updatedAt":"2019-06-09" } | { "status": 200, "message": "course data updated"} |